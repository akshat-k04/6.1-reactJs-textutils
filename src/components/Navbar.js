  ...
  <>
      <nav className={`navbar navbar-expand-lg  bg-${hiii.mode}`}>
          <div className="container-fluid">
                  <a className={`navbar-brand text-${hiii.textMode}`} href="/6.1-reactJs-textutils">{hiii.title}</a>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                      <li className="nav-item">
                              <a className="nav-link active" aria-current="page" href="/6.1-reactJs-textutils">Home</a>
                      </li>
                      <li className="nav-item">
